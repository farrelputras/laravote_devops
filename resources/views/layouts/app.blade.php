                        ...
                        @else
                          ...
                          <li class="nav-item">
                              <a href="{{route('users.index')}}"
                                 class="nav-link">Managemen Pengguna</a>
                          </li>
                          <li class="nav-item">
                              <a href="{{route('candidates.index')}}"
                                 class="nav-link">Managemen Kandidat</a>
                          </li>
                          <li class="nav-item">
                              <form method="POST"
                                    action="{{ route('voting.session') }}"
                          ...
                          <li class="nav-item">
                              <a href="{{route('candidates.pilihan')}}"
                                 class="nav-link">Pilihan</a>
                          </li>
                          @endif
